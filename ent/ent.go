...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			accountbalances.Table:  accountbalances.ValidColumn,
			accountdetails.Table:   accountdetails.ValidColumn,
			accountflags.Table:     accountflags.ValidColumn,
			accounts.Table:         accounts.ValidColumn,
			banners.Table:          banners.ValidColumn,
			debitcarddesign.Table:  debitcarddesign.ValidColumn,
			debitcarddetails.Table: debitcarddetails.ValidColumn,
			debitcardstatus.Table:  debitcardstatus.ValidColumn,
			debitcards.Table:       debitcards.ValidColumn,
			transactions.Table:     transactions.ValidColumn,
			usergreetings.Table:    usergreetings.ValidColumn,
