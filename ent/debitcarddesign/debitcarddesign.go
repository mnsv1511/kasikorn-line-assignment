...
const (
	// Label holds the string label denoting the debitcarddesign type in the database.
	Label = "debit_card_design"
	...
	FieldColor = "color"
	// FieldBorderColor holds the string denoting the border_color field in the database.
	...
	// Table holds the table name of the debitcarddesign in the database.
	Table = "debit_card_designs"
	// UsersTable is the table that holds the users relation/edge.
	UsersTable = "debit_card_designs"
	...
	DebitCardsTable = "debit_card_designs"
...
// Columns holds all SQL columns for debitcarddesign fields.
var Columns = []string{
	FieldID,
	FieldCardID,
	FieldUserID,
...
// OrderOption defines the ordering options for the DebitCardDesign queries.
...
// ByBorderColor orders the results by the border_color field.
func ByBorderColor(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldBorderColor, opts...).ToFunc()
}
