...
const (
	// Label holds the string label denoting the debitcardstatus type in the database.
	Label = "debit_card_status"
	...
	// Table holds the table name of the debitcardstatus in the database.
	Table = "debit_card_status"
	// UsersTable is the table that holds the users relation/edge.
	UsersTable = "debit_card_status"
	...
	DebitCardsTable = "debit_card_status"
...
// Columns holds all SQL columns for debitcardstatus fields.
var Columns = []string{
	FieldID,
	FieldCardID,
	FieldUserID,
...
// OrderOption defines the ordering options for the DebitCardStatus queries.
